...
if __name__ == '__main__':
    ...
    # 8k
    parser.add_argument('--caption_path', default="datasets/flickr_caption_8k.txt")
    parser.add_argument('--image_path', default="datasets/Flickr8k and Flickr8kCN/Flicker8k_Dataset")
    # 30k
